...
enum KeyboardCommands: CaseIterable {
  ...
  var asCommand: KeyboardCommand {
    ...
    case .newTab:
      return KeyboardCommand(input: "n", modifierFlags: [.command])
    }
  }
...
extension TabBarVC {
  override var keyCommands: [UIKeyCommand]? {
    [
      ...
      UIKeyCommand(input: "4", modifierFlags: [], action: #selector(moveToTab4)),
      UIKeyCommand(input: "5", modifierFlags: [], action: #selector(moveToTab5)),
    ]
  }
