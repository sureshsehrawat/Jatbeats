        ...
        SettingsSection {
          SettingsRow(title: "Theme Color") {
            Menu(settings.themePreference.description) {
              ...
              Button(ThemePreference.cyan.description) {
                setThemePreference(preference: .cyan)
              }
              Button(ThemePreference.mint.description) {
                setThemePreference(preference: .mint)
              }
              Button(ThemePreference.indigo.description) {
                setThemePreference(preference: .indigo)
              }
              Button(ThemePreference.aqua.description) {
                setThemePreference(preference: .aqua)
              }
              Button(ThemePreference.royalBlue.description) {
                setThemePreference(preference: .royalBlue)
              }
              Button(ThemePreference.turquoise.description) {
                setThemePreference(preference: .turquoise)
              }
              Button(ThemePreference.brown.description) {
                setThemePreference(preference: .brown)
              }
            }
          }
        }
