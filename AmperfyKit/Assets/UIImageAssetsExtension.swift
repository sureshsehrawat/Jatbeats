...
extension UIImage {
  ...
  public static let musicLibrary = UIImage.create(systemName: "music.note")
  ...
  public static let airplayaudio = UIImage.create(systemName: "airplay.audio")
  ...
  public static let refresh = UIImage.create(systemName: "arrow.trianglehead.2.clockwise.rotate.90")
