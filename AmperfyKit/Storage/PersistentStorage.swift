...
public enum ThemePreference: Int, CaseIterable, Sendable {
  ...
  public var asColor: UIColor {
    ...
    case .red:
      return .systemRed
    case .yellow:
      return UIColor(red: 255/255, green: 235/255, blue: 0/255, alpha: 1.0) // #FFEB00
    case .orange:
      return .systemOrange
    case .purple:
      return UIColor(red: 176/255, green: 38/255, blue: 255/255, alpha: 1.0) // #B026FF
    case .pink:
      return UIColor(red: 255/255, green: 62/255, blue: 165/255, alpha: 1.0) // #FF3EA5
    case .cyan:
      return .systemCyan
    case .mint:
      return .systemMint
    case .indigo:
      return .systemIndigo
    case .aqua:
      return UIColor(red: 0/255, green: 180/255, blue: 216/255, alpha: 1.0) // #00b4d8
    case .royalBlue:
      return UIColor(red: 65/255, green: 185/255, blue: 225/255, alpha: 1.0) // #41B9E1
    case .turquoise:
      return UIColor(red: 48/255, green: 213/255, blue: 200/255, alpha: 1.0) // #30D5C8
    case .brown:
      return UIColor(red: 162/255, green: 132/255, blue: 94/255, alpha: 1.0) // #A2845E
    }
  }
}
  ...
  final public class Settings: Sendable {
    ...
    public var isHapticsEnabled: Bool {
      get { UserDefaults.standard.object(
        forKey: UserDefaultsKey.IsHapticsEnabled.rawValue) as? Bool ?? true }
    ...
    public var profilePicturePath: String? {
      get { UserDefaults.standard.string(forKey: UserDefaultsKey.ProfilePicturePath.rawValue) }
      set { UserDefaults.standard.set(newValue, forKey: UserDefaultsKey.ProfilePicturePath.rawValue) }
    }
  }
